...
class EmailsControllerISpec extends ServerBaseISpec with BeforeAndAfterEach with UserFunctionsWrapper
  ...
  val combinedApi1 = simpleAPI("api-1", "API 1", List.empty, ApiType.REST_API, PUBLIC)
  val combinedApi2 = simpleAPI("api-2", "API 2", List("CATEGORY1", "VAT"), ApiType.REST_API, PUBLIC)
  val combinedApi3 = simpleAPI("api-3", "API 3", List("TAX", "VAT"), ApiType.REST_API, PUBLIC)
  val combinedApi4 = simpleAPI("api-4", "API 4", List.empty, ApiType.REST_API, PUBLIC)
  val combinedApi5 = simpleAPI("api-5", "API 5", List.empty, ApiType.REST_API, PUBLIC)
  val combinedApi6 = simpleAPI("api-6", "API 6", List.empty, ApiType.XML_API, PUBLIC)
