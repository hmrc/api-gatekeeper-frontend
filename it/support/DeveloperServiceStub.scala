...
import model.{APICategory, APICategoryDetails, ApiDefinition, NewModel}
...
trait DeveloperServiceStub {
  ...
  def primeDeveloperServiceAllSuccessWithUsers(users: Seq[NewModel.RegisteredUser]): Unit = {
  ...
  def primeDeveloperServiceGetByEmails(users: Seq[NewModel.RegisteredUser]): Unit = {
  ...
  def primeDeveloperServiceEmailPreferencesByTopic(users: Seq[NewModel.RegisteredUser], topic: TopicOptionChoice): Unit = {
    ...
    def primeDeveloperServiceEmailPreferencesByTopicAndCategory(users: Seq[NewModel.RegisteredUser], topic: TopicOptionChoice, category: APICategoryDetails): Unit = {
    ...
    def primeDeveloperServiceEmailPreferencesBySelectedAPisTopicAndCategory(users: Seq[NewModel.RegisteredUser], selectedApis: Seq[ApiDefinition], topic: TopicOptionChoice): Unit = {
