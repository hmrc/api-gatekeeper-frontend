...
)(implicit val ec: ExecutionContext) extends FrontendController(mcc) with GatekeeperAuthorisationActions with GatekeeperAuthorisationHelper with WithDefaultFormBinding
