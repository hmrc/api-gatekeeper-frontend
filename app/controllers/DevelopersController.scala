...
class DevelopersController @Inject()(developerService: DeveloperService,
                                     ...
                                     developerDetailsView: DeveloperDetails,
                                     removeMfaView: RemoveMfa,
                                     removeMfaSuccessView: RemoveMfaSuccess,
                                     deleteDeveloperView: DeleteDeveloper,
                                     deleteDeveloperSuccessView: DeleteDeveloperSuccess,
