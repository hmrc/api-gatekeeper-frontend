...
object SubscriptionFields {
  ...
  case class SubscriptionFieldsWrapper(applicationId: ApplicationId, clientId: ClientId, apiContext: ApiContext, apiVersion: String, fields: Seq[SubscriptionFieldValue])
  ...
  case class SubscriptionFieldsPutRequest(clientId: ClientId, apiContext: ApiContext, apiVersion: String, fields: Map[String, String])
