...
case class ApprovedApplication(details: ApplicationReviewDetails, admins: Seq[NewModel.RegisteredUser], approvedBy: String, approvedOn: DateTime, verified: Boolean)
