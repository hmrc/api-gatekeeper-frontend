...
//     if (isSuperUser) {
//       find("rate-limit-tier").element.text shouldBe s"Rate limit tier: $rateLimitTier"
...
//         Driver.instance.findElement(By.id("rate-limit-tier"))
//       }
//       intercept[NoSuchElementException] {
//         Driver.instance.findElement(By.id("rate-limit-tier-table"))
//       }
//     }
//   }
