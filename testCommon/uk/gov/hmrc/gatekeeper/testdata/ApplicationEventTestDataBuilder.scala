...
trait ApplicationEventTestDataBuilder {
  ...
  def makeTeamMemberAddedEvent(applicationId: ApplicationId, counter: Int = 1): TeamMemberAddedEvent = {
    ...
    teamMemberAddedExample.copy(applicationId = applicationId, id = EventId.random, eventDateTime = LocalDateTime.now(), teamMemberEmail = teamMember.email, teamMemberRole = "ADMIN")
  }
  ...
  def makeTeamMemberRemovedEvent(applicationId: ApplicationId, counter: Int = 1): TeamMemberRemovedEvent = {
    val teamMember = makeAppAdministrator(counter)
    teamMemberRemovedExample.copy(applicationId = applicationId, id = EventId.random, eventDateTime = LocalDateTime.now(), teamMemberEmail = teamMember.email, teamMemberRole = "ADMIN")
  }
