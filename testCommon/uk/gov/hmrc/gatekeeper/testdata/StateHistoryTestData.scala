...
trait StateHistoryTestData extends StateHistoryBuilder with CommonTestData {
  ...
  val stateHistories = List(
    buildStateHistory(applicationId, State.TESTING, Actors.AppCollaborator(administratorEmail.toLaxEmail), DateTime.parse("2019-08-22T11:21:50.160+01:00")),
    buildStateHistory(applicationId, State.PENDING_GATEKEEPER_APPROVAL, Actors.AppCollaborator(administratorEmail.toLaxEmail), DateTime.parse("2019-08-22T11:23:10.644+01:00")),
