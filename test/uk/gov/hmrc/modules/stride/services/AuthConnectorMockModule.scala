...
import uk.gov.hmrc.modules.stride.domain.models.GatekeeperRoles._
...
trait AuthConnectorMockModule {
  ...
  protected trait BaseAuthConnectorMock {
    ...
    object Authorise {
      ...
      private lazy val predicateUserRole = StrideAuthPredicateForGatekeeperRole(strideAuthRoles)(USER)
      private lazy val predicateSuperUserRole = StrideAuthPredicateForGatekeeperRole(strideAuthRoles)(SUPERUSER)
      private lazy val predicateAdminRole = StrideAuthPredicateForGatekeeperRole(strideAuthRoles)(ADMIN)
