...
class EmailPreferencesSelectedSubscribedApiViewSpec extends CommonViewSpec with EmailPreferencesAPICategoryViewHelper {
  ...
  trait Setup extends AppConfigMock {
    ...
    val api1                                                                                 = simpleAPI(serviceName = "serviceName1", displayName = "displayName1", Set.empty, ApiType.REST_API, ApiAccessType.PUBLIC)
    val api2                                                                                 = simpleAPI(serviceName = "serviceName2", displayName = "displayName2", Set.empty, ApiType.XML_API, ApiAccessType.PUBLIC)
