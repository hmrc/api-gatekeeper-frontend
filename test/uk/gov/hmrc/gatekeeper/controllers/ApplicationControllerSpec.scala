...
import uk.gov.hmrc.gatekeeper.views.html.applications.{ManageAutoDeleteFalseView, ManageAutoDeleteTrueView, _}
...
class ApplicationControllerSpec
  ...
  private lazy val manageAutoDeleteTrueView      = app.injector.instanceOf[ManageAutoDeleteTrueView]
  private lazy val manageAutoDeleteFalseView     = app.injector.instanceOf[ManageAutoDeleteFalseView]
  ...
  running(app) {
    ...
    trait Setup extends ControllerSetupBase
      ...
      val underTest = new ApplicationController(
        ...
        manageAutoDeleteTrueView,
        manageAutoDeleteFalseView,
...
"""
    ...
    "manageAutoDeletePage" should {
      "return the manage auto delete true page for an admin" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.ADMIN)
      ...
      "return the manage auto delete true page for a super user" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.SUPERUSER)
        givenTheAppWillBeReturned()
      ...
      "return the error page when auto delete false and no events found and GK user is admin" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.ADMIN)
      ...
      "return the error page when auto delete false and no events found and GK user is super user" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.SUPERUSER)
        ApplicationServiceMock.FetchApplication.returns(appWithAutoDeleteFalse)
        when(eventsConnector.query(*[ApplicationId], *, *, *)(*)).thenReturn(Future.successful(List.empty))
      ...
      "return the manage auto delete false page when an event exists and GK user is admin" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.ADMIN)
        ApplicationServiceMock.FetchApplication.returns(appWithAutoDeleteFalse)
      ...
      "return the manage auto delete false page when an event exists and GK user is super user" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.SUPERUSER)
        ApplicationServiceMock.FetchApplication.returns(appWithAutoDeleteFalse)
        when(eventsConnector.query(*[ApplicationId], *, *, *)(*)).thenReturn(Future.successful(events))
    ...
    "updateAutoDeletePreviouslyTrue" should {
      ...
      "call the service to set the allowAutoDelete flag to true when a valid form is submitted for a super user" in new Setup {
        ...
        val result = addToken(underTest.updateAutoDeletePreviouslyTrue(applicationId))(request)
      ...
      "call the service to set the allowAutoDelete flag to false when a valid form is submitted for a super user" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.SUPERUSER)
    ...
    "updateAutoDeletePreviouslyFalse" should {
      ...
      "call the service to set the allowAutoDelete flag to true when a valid form is submitted for an admin user" in new Setup {
        ...
        val result = addToken(underTest.updateAutoDeletePreviouslyFalse(basicAppWithAutoDeleteFalseId))(request)
      ...
      "show to autoDeleteSuccessView when confirm is set to 'no' on valid form by an admin user" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.ADMIN)
      ...
      "show to autoDeleteSuccessView when confirm is set to 'no' on valid form by a super user" in new Setup {
        StrideAuthorisationServiceMock.Auth.succeeds(GatekeeperRoles.SUPERUSER)
