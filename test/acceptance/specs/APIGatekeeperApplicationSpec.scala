...
import acceptance.pages.ApplicationPage.APIFilter.{NOSUBSCRIPTION, ONEORMORESUBSCRIPTION}
...
class APIGatekeeperApplicationSpec extends BaseSpec with SignInSugar with Matchers with CustomMatchers with MockDataSugar with GivenWhenThen {
  ...
  feature("Application List for Search Functionality") {
    ...
    scenario("Ensure a user can view a list of Applications") {
      ...
      on(ApplicationPage)
      assertNumberOfApplicationsPerPage(100)
      Thread.sleep(80000)
    }
    ...
    scenario("Ensure a user can view ALL applications") {
      ...
      val applications: Seq[(String, String, String,String)] = List(("Purnimas Application", "24.03.2016", "","Approved"),
                                                                    ("My new app", "08.04.2016", "Individual benefits","Approved"),
                                                                    ("An application for my user","08.06.2016","","Sandbox"),
                                                                    ("Mango", "21.07.2016", "","Pending"),
...
//      val applications3: Seq[(String, String, String,String)] = List(("Mango", "21.07.2016", "","Pending"))
//
