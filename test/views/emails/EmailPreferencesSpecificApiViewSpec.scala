...
import model.{ApiDefinition, LoggedInUser, NewModel, TopicOptionChoice, UserId}
...
class EmailPreferencesSpecificApiViewSpec extends CommonViewSpec with EmailPreferencesSpecificAPIViewHelper {
  ...
  "email preferences specific api view" must {
    ...
    val user1 = NewModel.RegisteredUser("user1@hmrc.com", UserId.random, "userA", "1", verified = true)
    val user2 = NewModel.RegisteredUser("user2@hmrc.com", UserId.random, "userB", "2", verified = true)
